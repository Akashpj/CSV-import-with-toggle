...
Note:- The “Heplatform” table schema has writen in .install file, so that table will be created automatically once you install the module and you check the data which you have imported.
